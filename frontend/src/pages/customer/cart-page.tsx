...
const CartPage = () => {
  ...
  const handleOpenBreakdown = () => {
    ...
    setTimeout(() => setShowBreakdown(true), 10);
  };

  const handleCloseBreakdown = () => {
    setShowBreakdown(false);
    setTimeout(() => setOpenBreakdown(false), 300);
  };
      ...
      >
          ...
          <div className="flex flex-col md:flex-row gap-6 items-start">
            ...
            <div className="md:w-1/4 w-full hidden lg:flex flex-col gap-4">
              ...
              >
                ...
                {isEligibleForFreeDelivery && (
                  <div
                    className="mb-4 p-3 rounded-lg text-xs font-medium text-center"
        ...
        >
          <div className="max-w-4xl mx-auto flex items-center justify-between gap-4">
            <div>
              ...
              {isEligibleForFreeDelivery && (
                <div className="text-xs whitespace-nowrap text-green-600 font-medium">
        ...
        {openBreakdown && (
          <div className="md:hidden fixed inset-0 z-20">
            ...
            />
            <div
              className={`absolute bottom-0 left-0 right-0 rounded-t-2xl p-5 pb-8 flex flex-col gap-3 transition-transform duration-300 ease-out ${
                showBreakdown ? 'translate-y-0' : 'translate-y-full'
              }`}
              style={{
                backgroundColor: 'var(--color-surface)',
                borderTop: '1px solid var(--color-border)',
